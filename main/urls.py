...
urlpatterns = [
    ...
    path('admin/schedule-management/group/get-info/<str:group_key>', admin_views.admin_schedule_group_get_info,
         name='admin_schedule_group_get_info'),
    path('admin/schedule-management/group/edit/<str:group_key>', admin_views.admin_schedule_group_edit,
         name='admin_schedule_group_edit'),
    path('admin/schedule-management/group/delete/<str:group_key>', admin_views.admin_schedule_group_delete,
         name='admin_schedule_group_delete'),
    ...
    path('lecturer/attendance-by-face/<int:classroom_id>/live-attendance', lecturer_views.lecturer_live_attendance_today,
         name='lecturer_live_attendance_today'),
